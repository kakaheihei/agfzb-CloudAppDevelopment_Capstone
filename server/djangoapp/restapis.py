...
def analyze_review_sentiments(dealer_review):
    api_url = "https://api.eu-gb.natural-language-understanding.watson.cloud.ibm.com/instances/9a44db7f-6240-4475-92cd-e1c65b99f260"

    
    # Call get_request with a URL parameter and Watson NLU parameters
    json_result = get_request(api_url,  api_key="0Ph789ZofziUszw54ULkapu2c2juAaBVv8R5VpceqmnM",
                                        version="2020-08-01",
                                        text=dealer_review,
                                        features="sentiment",
